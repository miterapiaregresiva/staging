...
const relatedCards = items => (items||[]).map(x => `<article class="card"><div class="book-cover"><img src="${esc(x.cover)}" alt="Portada de ${esc(x.title)}" loading="lazy"></div><h3><a href="/autores/${authorSlug}/libros/${esc(x.slug)}/">${esc(x.title)}</a></h3><p><strong>Original:</strong> <em>${esc(x.original_title)}</em>.</p></article>`).join('');
