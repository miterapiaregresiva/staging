...
@media(max-width:700px){
  ...
  .site-header .nav{position:relative;display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:.5rem;padding:.35rem 1.25rem;min-height:68px;text-align:left}
  .site-header .brand-lockup{margin:0;justify-content:flex-start;gap:.55rem;width:auto;max-width:min(100%,20rem);min-height:0}
  .site-header .brand-lockup .brand-symbol{width:48px;height:48px;flex:0 0 48px}
  .site-header .brand-lockup .brand-copy{display:flex;flex-direction:column;gap:.22rem;min-width:0;text-align:left}
  .site-header .brand-lockup .brand-domain{display:block;font-size:clamp(.98rem,4.4vw,1.2rem);line-height:1.05;overflow:hidden;text-overflow:ellipsis}
  .site-header .brand-lockup .brand-tagline{display:none}
  .site-header .brand-lockup .brand-service{display:block;white-space:normal;font-size:.58rem;line-height:1.2;letter-spacing:.09em;color:#514b52}
  .site-header .brand-lockup .brand-service::before,.site-header .brand-lockup .brand-service::after{display:none}
  ...
  .site-header .mobile-nav-enhanced.mobile-menu-open .menu a{display:flex!important;width:100%;min-height:48px;align-items:center;justify-content:flex-end;text-align:right;padding:.65rem .75rem;border-radius:12px;font-size:1rem;line-height:1.3}
...
@media(max-width:390px){
  ...
  .site-header .brand-lockup{max-width:min(100%,17rem)}
  ...
  .site-header .brand-lockup .brand-service{font-size:.54rem;letter-spacing:.065em}
...
`;
  ...
  if(!document.getElementById('sprint-08-styles')){const s=document.createElement('style');s.id='sprint-08-styles';s.textContent='.footer-legal{margin-top:2rem;padding-top:1.25rem;border-top:1px solid var(--line);font-size:.84rem}.footer-legal p{margin:0}.editorial-link{font-weight:550;text-decoration:underline;text-decoration-thickness:.08em;text-underline-offset:.22em}.actions .editorial-link{display:inline-flex;align-items:center;min-height:48px;padding:.55rem .1rem}.whatsapp-float{position:fixed;right:max(1rem,env(safe-area-inset-right));bottom:max(1rem,env(safe-area-inset-bottom));z-index:50;min-width:54px;height:54px;padding:0 .95rem;border-radius:999px;display:flex;align-items:center;justify-content:center;background:#25d366;color:#12351e;font-weight:700;text-decoration:none;box-shadow:0 4px 16px rgba(0,0,0,.12);animation:none}.whatsapp-float::before{display:none!important;content:none!important}.whatsapp-float:hover,.whatsapp-float:focus-visible{background:#1da851}.button{min-height:48px;padding:.75rem 1.15rem}@media(max-width:700px){.whatsapp-float{width:52px;min-width:52px;height:52px;padding:0;font-size:0}.whatsapp-float::after{content:"";width:28px;height:28px;background-repeat:no-repeat;background-position:center;background-size:contain;background-image:url("data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 32 32%27%3E%3Cpath fill=%27white%27 d=%27M16.75 2.25c-7.1 0-12.87 5.76-12.87 12.86 0 2.27.6 4.49 1.73 6.44L3.77 28.25l6.86-1.8a12.87 12.87 0 1 0 6.12-24.2zm0 23.33c-1.94 0-3.84-.53-5.49-1.54l-.39-.23-4.07 1.07 1.09-3.97-.26-.41a10.42 10.42 0 1 1 9.12 5.08zm5.72-7.81c-.31-.16-1.85-.91-2.14-1.02-.29-.1-.5-.16-.71.16-.21.31-.81 1.02-.99 1.23-.18.21-.37.24-.68.08-.31-.16-1.32-.49-2.51-1.55-.93-.83-1.55-1.85-1.73-2.16-.18-.31-.02-.48.14-.64.14-.14.31-.37.47-.55.16-.18.21-.31.31-.52.1-.21.05-.39-.03-.55-.08-.16-.71-1.71-.97-2.34-.25-.63-.51-.54-.71-.55h-.6c-.21 0-.55.08-.84.39-.29.31-1.1 1.07-1.1 2.61s1.12 3.03 1.28 3.24c.16.21 2.21 3.37 5.35 4.73.75.32 1.33.52 1.78.66.75.24 1.43.21 1.97.13.6-.09 1.85-.76 2.11-1.49.26-.73.26-1.36.18-1.49-.08-.13-.29-.21-.6-.37z%27/%3E%3C/svg%3E")}}@media(prefers-reduced-motion:reduce){.whatsapp-float{animation:none}}';document.head.appendChild(s)}
});
